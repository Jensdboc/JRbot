...
def test_royal_flush():
    ...
    assert royal_flush(cards)[0], 'This should be a royal flush!'
    ...
    assert not royal_flush(cards)[0], "This shouldn't be a royal flush!"
...
def test_straight_flush():
    ...
    assert straight_flush(cards_straight_flush)[0] and straight_flush(cards2_straight_flush)[0] and straight_flush(cards3_straight_flush)[0], 'This should be a straight flush!'
    ...
    assert not straight_flush(cards_no_straight_flush)[0] and not straight_flush(cards2_no_straight_flush)[0] and not straight_flush(cards3_no_straight_flush)[0], "This shouldn't be a straight flush!"
...
def test_four_of_a_kind():
    ...
    assert four_of_a_kind(cards)[0], 'This should be a four of a kind!'
    ...
    assert not four_of_a_kind(cards)[0], "This shouldn't be a four of a kind!"
...
def test_full_house():
    ...
    assert full_house(cards)[0], 'This should be a full house!'
    ...
    assert full_house(cards)[0], 'This should also be a full house!'
    ...
    assert not full_house(cards)[0], "This shouldn't be a full house!"
...
def test_flush():
    ...
    assert flush(cards)[0], 'This should be a flush!'
    ...
    assert flush(cards)[0], 'This should also be a flush!'

    cards = [Card('hearts', 'jack'), Card('diamonds', 'five'), Card('diamonds', 'jack'), Card('spades', 'ace'), Card('spades', 'five'), Card('clubs', 'deuce'), Card('hearts', 'ace')]

    assert not flush(cards)[0], "This shouldn't be a flush!"
...
def test_straight():
    ...
    assert straight(cards_straight)[0] and straight(cards2_straight)[0] and straight(cards3_straight)[0], 'This should be a straight!'
    ...
    assert not straight(cards_no_straight)[0], "This shouldn't be a straight!"
...
def test_three_of_a_kind():
    ...
    assert three_of_a_kind(cards)[0], 'This should be a three of a kind!'
    ...
    assert not three_of_a_kind(cards)[0], "This shouldn't be a three of a kind!"
...
def test_two_pair():
    ...
    assert two_pair(cards)[0], 'This should be a two pair!'
    ...
    assert two_pair(cards)[0], 'This should also be a two pair!'
    ...
    assert not two_pair(cards)[0], "This shouldn't be a two pair!"
...
def test_one_pair():
    ...
    assert one_pair(cards)[0], 'This should be a one pair!'
    ...
    assert not one_pair(cards)[0], "This shouldn't be a one pair!"
